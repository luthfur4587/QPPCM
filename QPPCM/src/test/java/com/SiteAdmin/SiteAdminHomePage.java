...
public class SiteAdminHomePage extends SiteAdminBase {
	...
	public void checkCaseToRun() throws IOException, InterruptedException, ATUTestRecorderException {
		...
		FilePath = TestCaseListExcelSiteAdmin;		
	...
	public void TestName(String username, String wrongPwd, String rightPwd, String expectedResult, String actualResult) throws InterruptedException{
		...
		try {
			doLogin(Param.getProperty("SiteAdminUserID"), Param.getProperty("SiteAdminPassword"));
//			getElement("ChooseAuthor_xpath").click();
			...
			String g=getElement("HeaderSiteAdmin_xpath").getText();
			String h=getElement("SiteAdminIcon_xpath").getText();
			if (!(a.equals("Author")&& b.equals("Approver")&& c.equals("Welcome Luthfur Khan")&& d.equals("Choose:")
				&& e.equals("Author")&& f.equals("Approver")&& g.equals("Admin")&& h.equals("Admin"))){
			...
			reportInfo(getUrl());
			if (!(getUrl().contains(".cms.gov/web/admin/content"))){
				reportFailure(getUrl());
				Testfail=true;
				s_assert.fail();
			}

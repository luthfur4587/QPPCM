...
public class AuthorAddLinkContent extends AuthorAddContentsBase {
	...
	public void TestName(String username, String wrongPwd, String rightPwd, String expectedResult, String actualResult) throws Exception{
		...
		try {
			...
			type("Title_xpath", "TestAutomationLinkTitle");
			String url=getUrl();
			type("URLforLink_xpath", url);
			type("selectYear_xpath", "2018");
			type("selectCategory_xpath", "-- Quality");

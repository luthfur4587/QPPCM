...
public class ApplicationDataMigrationBase extends SuiteBase {
	...
	public void checkSuiteToRun() throws IOException {
		...
		SuiteName = "ApplicationDataMigration";
		ToRunColumnName = "SuiteToRun";
		
		//Bellow given syntax will Insert log In applog.log file.
		Add_Log.info("Execution started for ApplicationDataMigrationBase.");
